...
router.get('/', async (req, res) => {
    ...
    async function JAVA-BOY-MR2K-MD_PAIR_CODE() {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'JAVA-BOY-MR2K-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb6ULcfEawduL2qfWE37) 

🇿🇲 *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/kingmalvn/)  

🚀 _Thanks for choosing JAVA-BOY-MR2K-MD — Let the automation begin!_ ✨🇿🇲`;
    ...
    await JAVA-BOY-MR2K-MD_PAIR_CODE();
});
